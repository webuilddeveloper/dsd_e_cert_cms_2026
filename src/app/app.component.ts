  ...
  constructor(
    ...
    this.menuCategory = [
      ...
      },
      {
       ...
       {
        'name': 'หมวดหมู่ฝีมือแรงงาน',
        'routing': 'skilled-labor-category',
        'data': '',
        'type': 'N',
        'isActive': false,
        'isShow': this.category.skilledLaborCategoryPage
      },
      {
    ...
    this.menuMain = [
      ...
      },
      {
        ...
        'type': 'N',
        'isActive': false,
        'isShow': this.category.skilledLaborPage
      },
      {
        'name': 'อาสาเตือนภัย',
        'routing': '/warning',
