...
@Component({
  selector: 'app-skilled-labor-category-criteria',
  templateUrl: './skilled-labor-category-criteria.component.html',
  styleUrls: ['./skilled-labor-category-criteria.component.css']
})
export class SkilledLaborCategoryCriteriaComponent implements OnInit {
