...
@Component({
  selector: 'app-skilled-labor-category',
  templateUrl: './skilled-labor-category.component.html',
  styleUrls: ['./skilled-labor-category.component.css']
})
export class SkilledLaborCategoryComponent implements OnInit {
  model: any = [];
  listModel: string = '';
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('skilledLaborCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('skilledLaborCategoryPage'));
