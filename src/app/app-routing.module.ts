...
import { SkilledLaborComponent } from "./skilled-labor/skilled-labor.component";
import { SkilledLaborEditComponent } from "./skilled-labor/skilled-labor-edit/skilled-labor-edit.component";
import { SkilledLaborCategoryComponent } from "./skilled-labor-category/skilled-labor-category.component";
import { SkilledLaborCategoryEditComponent } from "./skilled-labor-category/skilled-labor-category-edit/skilled-labor-category-edit.component";
...
const routes: Routes = [
  ...
  {
    path: "privilege-category-edit/:code",
    component: PrivilegeCategoryEditComponent,
  },
  ...
  {
    path: "contact-category-edit/:code",
    component: ContactCategoryEditComponent,
  },
  ...
  {
    path: "knowledge-category-edit/:code",
    component: KnowledgeCategoryEditComponent,
  },
  ...
  {
    path: "organization-lv0-edit/:code",
    component: Organization2Lv0EditComponent,
  },
  {
    path: "organization-lv1-edit/:code",
    component: Organization2Lv1EditComponent,
  },
  {
    path: "organization-lv2-edit/:code",
    component: Organization2Lv2EditComponent,
  },
  {
    path: "organization-lv3-edit/:code",
    component: Organization2Lv3EditComponent,
  },
  {
    path: "organization-lv4-edit/:code",
    component: Organization2Lv4EditComponent,
  },
  ...
  {
    path: "notification-category-edit/:code",
    component: NotificationCategoryEditComponent,
  },
  ...
  {
    path: "welfare-category-edit/:code",
    component: WelfareCategoryEditComponent,
  },
  ...
  {
    path: "training-category-edit/:code",
    component: TrainingCategoryEditComponent,
  },
  ...
  {
    path: "reporter-category-edit/:code",
    component: ReporterCategoryEditComponent,
  },
  ...
  {
    path: "warning-category-edit/:code",
    component: WarningCategoryEditComponent,
  },
  { path: "policy-application", component: PolicyApplicationComponent },
  {
    path: "policy-application-edit/:code",
    component: PolicyApplicationEditComponent,
  },
  { path: "policy-marketing", component: PolicyMarketingComponent },
  {
    path: "policy-marketing-edit/:code",
    component: PolicyMarketingEditComponent,
  },
  {
    path: "member-mobile-policy-application",
    component: MemberMobilePolicyApplicationComponent,
  },
  {
    path: "member-mobile-policy-marketing",
    component: MemberMobilePolicyMarketingComponent,
  },
  ...
  {
    path: "cooperative-form-edit/:code",
    component: CooperativeFormEditComponent,
  },
  {
    path: "cooperative-form-category",
    component: CooperativeFormCategoryComponent,
  },
  {
    path: "cooperative-form-category-edit/:code",
    component: CooperativeFormCategoryEditComponent,
  },
  { path: "coming-soon", component: ComingSoonComponent },
  { path: "coming-soon-edit/:code", component: ComingSoonEditComponent },
  { path: "skilled-labor", component: SkilledLaborComponent },
  { path: "skilled-labor-edit/:code", component: SkilledLaborEditComponent },
  { path: "skilled-labor-category", component: SkilledLaborCategoryComponent },
  {
    path: "skilled-labor-category-edit/:code",
    component: SkilledLaborCategoryEditComponent,
  },
];
