...
import { SkilledLaborCriteriaComponent } from "./skilled-labor/skilled-labor-criteria/skilled-labor-criteria.component";
import { SkilledLaborListComponent } from "./skilled-labor/skilled-labor-list/skilled-labor-list.component";
import { SkilledLaborEditComponent } from "./skilled-labor/skilled-labor-edit/skilled-labor-edit.component";
import { SkilledLaborCategoryCriteriaComponent } from "./skilled-labor-category/skilled-labor-category-criteria/skilled-labor-category-criteria.component";
import { SkilledLaborCategoryComponent } from "./skilled-labor-category/skilled-labor-category.component";
import { SkilledLaborCategoryListComponent } from "./skilled-labor-category/skilled-labor-category-list/skilled-labor-category-list.component";
...
@NgModule({
  declarations: [
    ...
    SkilledLaborComponent,
    SkilledLaborCriteriaComponent,
    SkilledLaborEditComponent,
    SkilledLaborListComponent,
    SkilledLaborCategoryComponent,
    SkilledLaborCategoryCriteriaComponent,
    SkilledLaborCategoryListComponent,
    SkilledLaborCategoryEditComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
