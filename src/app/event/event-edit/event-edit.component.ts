...
export class EventEditComponent implements OnInit {
  ...
  create() {
    ...
    this.serviceProviderService
      .post("eventcalendar/create", this.editModel)
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
          if (this.editModel.gallery.length > 0) {
            this.editModel.gallery.forEach((element) => {
              ...
              this.serviceProviderService
                .post("eventCalendar/gallery/create", element)
                .subscribe(
                  (data) => {},
                  (err) => {},
                );
  ...
  readComment() {
    this.serviceProviderService
      .post("eventCalendar/comment/read", { code: this.code })
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  update() {
    ...
    this.spinner.show();
    this.serviceProviderService
      .post("eventcalendar/update", this.editModel)
      .subscribe(
        (data) => {
          this.serviceProviderService
            .post("eventcalendar/gallery/delete", this.editModel)
            .subscribe(
              (data) => {
                if (this.editModel.gallery.length > 0) {
                  this.editModel.gallery.forEach((element) => {
  ...
  readCategory(param) {
    ...
    if (this.editModel.language != "") {
      this.serviceProviderService
        .post("eventcalendar/category/read", {
          language: param,
          permission: this.permission,
        })
        .subscribe(
  ...
  galleryRead() {
    this.serviceProviderService
      .post("m/eventcalendar/gallery/read", { code: this.editModel.code })
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  manageComment(param) {
    ...
    this.spinner.show();
    this.serviceProviderService
      .post("eventCalendar/comment/update", param)
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  verifyComment(param) {
    this.spinner.show();
    this.serviceProviderService
      .post("eventCalendar/comment/verify", param)
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  exportAsXLSX(): void {
    this.serviceProviderService
      .post("eventCalendar/comment/read", { skip: 0, limit: 999999 })
      .subscribe(
        (data) => {
          let model: any = {};
          let result: any = [];
