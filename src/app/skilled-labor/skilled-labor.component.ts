...
@Component({
  selector: 'app-skilled-labor',
  templateUrl: './skilled-labor.component.html',
  styleUrls: ['./skilled-labor.component.css']
})
export class SkilledLaborComponent implements OnInit {
  model: any = [];
  listModel: string = '';
  ...
  read() {
    ...
    this.serviceProviderService.post('skilledLabor/read', this.criteriaModel).subscribe(data => {
      setTimeout(() => {
        let model: any = {};
        model = data;
