...
export class TrainingEditComponent implements OnInit {
  ...
  create() {
    ...
    this.serviceProviderService
      .post("training/create", this.editModel)
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  read() {
    this.spinner.show();
    this.serviceProviderService
      .post("training/read", { code: this.code, permission: this.permission })
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  readTrainingRegister() {
    ...
    this.serviceProviderService
      .post("training/register/read", this.criteriaModel)
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  update() {
    ...
    this.serviceProviderService
      .post("training/update", this.editModel)
      .subscribe(
        (data) => {
          this.serviceProviderService
  ...
  galleryRead() {
    this.serviceProviderService
      .post("m/training/gallery/read", { code: this.editModel.code })
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
